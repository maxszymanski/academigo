...
function LearnSkill() {
	return (
		<section className="  relative py-16   flex container mx-auto flex-col md:flex-row justify-between lg:py-20  items-start xl:py-24">
			<Image src="/hire.jpg" height={768} width={600} alt="szcześliwy student" />
			<div className="flex flex-col gap-6 lg:px-6 lg:self-center lg:w-1/2 px-6 w-full items-center lg:items-start pt-8">
