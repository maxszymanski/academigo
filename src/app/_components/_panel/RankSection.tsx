...
function RankSection() {
    return (
        <div className="py-8 scrollbar-none xl:h-[792px] xl:overflow-y-auto xl:rounded-3xl xl:bg-white 2xl:h-[552px]">
            ...
            <div className="flex w-full items-center justify-evenly gap-5 overflow-x-auto px-5 py-6 scrollbar-thin scrollbar-track-primary scrollbar-thumb-primary2 sm:gap-8 xl:flex-col xl:px-8">
                <RankCard
                    ranking={courseRank}
