...
function MobileNav({ blackNav = false, pathname }: { blackNav?: boolean; pathname: string | null | undefined }) {
	...
	return (
		<div
			...
			<Button
				...
				{isNavOpen ? (
					<IoClose className={`size-12 font-semibold text-primary ${blackNav ? 'bg-dark' : 'bg-white'}`} />
				) : (
