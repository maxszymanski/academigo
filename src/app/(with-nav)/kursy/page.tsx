import Search from '@/app/_components/_courses/Search'
import Filters from '@/app/_components/_courses/Filters'
import SortAndResults from '@/app/_components/_courses/SortAndResults'
import { getCategories, getCoursesByFilter } from '@/app/_lib/data-service'
import CategoriesDesktop from '@/app/_components/_courses/CategoriesDesktop'
import SubCategories from '@/app/_components/_courses/SubCategories'
import Specialization from '@/app/_components/_courses/Specialization'
import CourseHeader from '@/app/_components/_courses/CourseHeader'
import CoursesResult from '@/app/_components/_courses/CoursesResult'
import SelectedFilters from '@/app/_components/_courses/SelectedFilters'
import ShowedCourses from '@/app/_components/_courses/ShowedCourses'
